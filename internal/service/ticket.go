...
func (s *Ticket_service) Ticket_create(title *string, email *string, priority *string, severity *string, environment *string, stepsToReproduce *string, expectedResult *string, actualResult *string, attachments *[]string) error {
	return s.repository.Ticket_create(title, email, priority, severity, environment, stepsToReproduce, expectedResult, actualResult, attachments)
}
